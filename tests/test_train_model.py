...
def test_save_load_model():
    ...
    assert np.array_equal(vg_distances,dist_loaded),"Saved and loaded distance data differ"
    assert np.array_equal(vg_indices,inds_loaded),"Saved and loaded indices data differ"