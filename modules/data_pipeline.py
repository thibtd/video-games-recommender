...
def get_data()->pd.DataFrame:
    ...
    #Load the dataset
    data:pd.DataFrame = pd.read_csv(path+"/imdb-videogames.csv" ,index_col='Unnamed: 0')
    return data
...
def clean_data(df:pd.DataFrame)->tuple:
    ...
    data['certificate'] = data.certificate.replace({'K-A':'E', 'EC':'E','GA':'E', 'CE':'T', '12':'T','PG-13':'T','MA-13':'T','G':'E', 'MA-17':'M','PG':'E','TV-MA':'M','TV-14':'T','Unrated':'Not Rated','Passed':'Not Rated','Approved':'Not Rated'})
...
def feature_engineering(df:pd.DataFrame,vectorizer_plot:TfidfVectorizer)->pd.DataFrame:
    """
