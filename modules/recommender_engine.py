...
def recommend_video_game_name(vg_name_input:str,game_names:pd.Series,vectorizer_name:TfidfVectorizer)->str:
    """
...
def recommend_video_games(vg_name_input:str, data_display:pd.DataFrame,vg_distances:np.ndarray,vg_indices:np.ndarray,
                          vectorizer_name:TfidfVectorizer)->pd.DataFrame:
